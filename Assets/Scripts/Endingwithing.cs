...
public class Endingwithing : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        fword.text = Constant19.ewing[i];
        temp.Add(Constant19.ewing[i]);
...
public void LevelNineteen()
    ...
    {   
        ...
        int n = s.Length;
        if(Constant19.ewing.Contains(s))
        {
            for (int i = 0; i < n; i++)
            {                    
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot19",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot19",1);
                            }
                            else
                            {
                                currentscore=0;
