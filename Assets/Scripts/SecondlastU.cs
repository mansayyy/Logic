...
public class SecondlastU : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        int i = random.Next(0, 7000);
        fword.text = Constant14.slu[i].ToLower();
        temp.Add(Constant14.slu[i].ToLower());
...
public void LevelFourteen()
    ...
    {   
        ...
        string s = theName.ToUpper();
        int n = s.Length;
        if(Constant14.slu.Contains(s))
        {
            for (int i = 0; i < n; i++)
            {
                ...
                if (s[n-2]=='U')
                {
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot14",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot14",1);
                            }
                            else
                            {
                                currentscore=0;
                            ...
                            if(currentlevel<=15)
                            {
                                PlayerPrefs.SetInt("levelsunlocked",15);
                            }
                            else
                            {
