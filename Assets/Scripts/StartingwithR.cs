...
public class StartingwithR : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        fword.text = Constant12.swr[i];
        temp.Add(Constant12.swr[i]);
                ...
                if (s[0]=='r')
                {
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot12",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot12",1);
                            }
                            else
                            {
                                currentscore=0;
                            ...
                            if(currentlevel<=13)
                            {
                                PlayerPrefs.SetInt("levelsunlocked",13);
                            }
                            else
                            {
