...
public class ConsVowels : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        int i = random.Next(0, 16600);
        fword.text = Constant20.swcl[i];
        temp.Add(Constant20.swcl[i]);
            ...
            {                    
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot20",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot20",1);
                            }
                            else
                            {
                                currentscore=0;
