...
public class EndingwithE : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        int i = random.Next(0, 1410);
        fword.text = Constant2.endwithe[i];
        temp.Add(Constant2.endwithe[i]);
...
public void LevelTwo()
    ...
    {   
        ...
        int n = s.Length;
        if(Constant2.endwithe.Contains(s))
        {
            for (int i = 0; i < n; i++)
            {
                if (s[n-1] == 'e')
                {
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot2",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot2",1);
                            }
                            else
                            {
                                currentscore=0;
