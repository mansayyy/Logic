...
public class Length5 : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        fword.text = Constant7.lenfive[i];
        temp.Add(Constant7.lenfive[i]);
...
public void LevelSeven()
    ...
    {   
        ...
        int n = s.Length;
        if(Constant7.lenfive.Contains(s))
        {
            for (int i = 0; i < n; i++)
            {
                if (n==5)
                {
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot7",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot7",1);
                            }
                            else
                            {
                                currentscore=0;
