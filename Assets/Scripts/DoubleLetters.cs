...
public class DoubleLetters : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        int i = random.Next(0, 590);
        fword.text = Constant6.dl[i];
        temp.Add(Constant6.dl[i]);
                ...
                if (dl==1)
                {
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot6",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot6",1);
                            }
                            else
                            {
                                currentscore=0;
