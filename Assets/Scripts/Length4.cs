...
public class Length4 : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        fword.text = Constant3.lenfour[i].ToLower();
        temp.Add(Constant3.lenfour[i].ToLower());
...
public void LevelThree()
    ...
    {   
        ...
        int n = s.Length;
        if(Constant3.lenfour.Contains(s))
        {
            for (int i = 0; i < n; i++)
            {
                if (n==4)
                {
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot3",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot3",1);
                            }
                            else
                            {
                                currentscore=0;
