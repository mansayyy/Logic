...
public class FirstASecondU : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        fword.text = Constant8.flaslu[i];
        temp.Add(Constant8.flaslu[i]);
...
public void LevelEight()
    ...
    {   
        ...
        int n = s.Length;
        if(Constant8.flaslu.Contains(s))
        {
            for (int i = 0; i < n; i++)
            {
                if ((s[0]=='a')&&(s[1]=='u'))
                {
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot8",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot8",1);
                            }
                            else
                            {
                                currentscore=0;
