...
public class StartingwithM : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        int i = random.Next(0, 1250);
        fword.text = Constant5.swm[i];
        temp.Add(Constant5.swm[i]);
                ...
                if (s[0]=='m')
                {
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot5",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot5",1);
                            }
                            else
                            {
                                currentscore=0;
