...
public class FirstandLastSame : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        int i = random.Next(0, 19000);
        fword.text = Constant13.fals[i];
        temp.Add(Constant13.fals[i]);
                ...
                if (s[0]==s[n-1])
                {
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot13",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot13",1);
                            }
                            else
                            {
                                currentscore=0;
                            ...
                            if(currentlevel<=14)
                            {
                                PlayerPrefs.SetInt("levelsunlocked",14);
                            }
                            else
                            {
