...
public class Endingwithtion : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        int i = random.Next(0, 850);
        fword.text = Constant4.endingwithtion[i];
        temp.Add(Constant4.endingwithtion[i]);
...
public void LevelFour()
    ...
    {   
        ...
        int n = s.Length;
        if(Constant4.endingwithtion.Contains(s))
        {
            for (int i = 0; i < n; i++)
            {
                if ((s[n-4]=='t')&&(s[n-3]=='i')&&(s[n-2]=='o')&&(s[n-1]=='n'))
                {
                    if(temp.Contains(s))
                    {                    
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot4",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot4",1);
                            }
                            else
                            {
                                currentscore=0;
