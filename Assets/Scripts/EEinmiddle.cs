...
public class EEinmiddle : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        fword.text = Constant16.dee[i];
        temp.Add(Constant16.dee[i]);
                ...
                if (dl==1)
                {
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot16",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot16",1);
                            }
                            else
                            {
                                currentscore=0;
