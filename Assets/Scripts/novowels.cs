...
public class novowels : MonoBehaviour
{
...
//finalscore
    ...
    public void Start()
    {
      ...
      public void GivefirstWord(){
        ...
        fword.text = Constant18.nvm[i];
        temp.Add(Constant18.nvm[i]);
            ...
            {                    
                    ...
                    else
                    {
                        ...
                        else if (correctAns == 2)
                        {
                            ...
                            int flag=PlayerPrefs.GetInt("Attemptedornot18",0);
                            if(flag==0)
                            {
                                if (tempf <= 5)
                                {
                                ...
                                PlayerPrefs.SetInt("Attemptedornot18",1);
                            }
                            else
                            {
                                currentscore=0;
                            ...
                            if(currentlevel<=19)
                            {
                                PlayerPrefs.SetInt("levelsunlocked",19);
                            }
                            else
                            {
